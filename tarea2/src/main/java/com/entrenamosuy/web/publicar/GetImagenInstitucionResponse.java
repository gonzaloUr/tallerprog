...
/**
 * <p>Clase Java para getImagenInstitucionResponse complex type.
 * 
 * <p>El siguiente fragmento de esquema especifica el contenido que se espera que haya en esta clase.
 * 
 * <pre>
 * &lt;complexType name="getImagenInstitucionResponse"&gt;
 *   &lt;complexContent&gt;
...
@XmlType(name = "getImagenInstitucionResponse", propOrder = {
    "_return"
})
public class GetImagenInstitucionResponse {
