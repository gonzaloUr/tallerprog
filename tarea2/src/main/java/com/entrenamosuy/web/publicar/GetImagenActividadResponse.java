...
/**
 * <p>Clase Java para getImagenActividadResponse complex type.
 * 
 * <p>El siguiente fragmento de esquema especifica el contenido que se espera que haya en esta clase.
 * 
 * <pre>
 * &lt;complexType name="getImagenActividadResponse">
 *   &lt;complexContent>
...
@XmlType(name = "getImagenActividadResponse", propOrder = {
    "_return"
})
public class GetImagenActividadResponse {
