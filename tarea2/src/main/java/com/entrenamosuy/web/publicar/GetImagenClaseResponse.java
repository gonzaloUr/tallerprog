...
/**
 * <p>Clase Java para getImagenClaseResponse complex type.
 * 
 * <p>El siguiente fragmento de esquema especifica el contenido que se espera que haya en esta clase.
 * 
 * <pre>
 * &lt;complexType name="getImagenClaseResponse"&gt;
 *   &lt;complexContent&gt;
...
@XmlType(name = "getImagenClaseResponse", propOrder = {
    "_return"
})
public class GetImagenClaseResponse {
