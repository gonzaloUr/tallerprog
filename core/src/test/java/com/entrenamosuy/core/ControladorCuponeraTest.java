...
public class ControladorCuponeraTest {
    ...
    void crearCuponera() {
        ...
        assertDoesNotThrow(() -> {
            ctrlC.crearCuponera().setNombre("cuponera1").setDescripcion("Todo lindo").setInicio(LocalDate.of(2021, 02, 10)).setFin(LocalDate.of(2021, 10, 10)).setDescuento(15).setFechaRegistro(LocalDate.of(2021, 01, 10)).invoke();
        });
        assertThrows(CuponeraInconsistenteException.class, () -> {
            ctrlC.crearCuponera().setNombre("cuponera1").setDescripcion("Todo lindo").setInicio(LocalDate.of(2021, 02, 10)).setFin(LocalDate.of(2021, 10, 10)).setDescuento(15).setFechaRegistro(LocalDate.of(2021, 01, 10)).invoke();
        });
    }
    ...
    */
    ...
    void varios() {
        ...
        assertDoesNotThrow(() -> {
            ...
            ctrlA.crearInstitucion("test", "test", new URL("https://test"));
            ctrlA.crearActividad().setInstitucion("test").setNombre("test").setDescripcion("test").setDuracion(Duration.ofHours(1)).setCosto(10.0f).setRegistro(LocalDate.of(2021, 9, 10)).invoke();
            ctrlA.crearActividad().setInstitucion("test").setNombre("test2").setDescripcion("test2").setDuracion(Duration.ofHours(1)).setCosto(10.0f).setRegistro(LocalDate.of(2021, 9, 10)).invoke();
            ctrlC.agregarACuponera("cuponera1", "test", 5);
            ctrlC.agregarACuponera("cuponera1", "test2", 5);
        ...
        assertDoesNotThrow(() -> {
            Cuponera cup = m.getCuponeras().get("cuponera1");
            ctrlA.crearActividad().setInstitucion("test").setNombre("test1").setDescripcion("test").setDuracion(Duration.ofHours(1)).setCosto(10.0f).setRegistro(LocalDate.of(2021, 9, 10)).invoke();
    ...
    void manejadortest() {
        ...
        assertDoesNotThrow(() -> {
            ...
            ctrlA.crearClase().setNombreActividad("test").setNombre("test").setInicio(LocalDateTime.of(2021, 10, 10, 0, 0)).setNicknameProfesores(profesores).setCantMin(2).setCantMax(10).setAcceso(new URL("https://test")).setFechaRegistro(LocalDate.of(2021, 10, 10)).invoke();
            man.setClases(cla);

            ctrlC.crearCuponera().setNombre("cuponera1").setDescripcion("Todo lindo").setInicio(LocalDate.of(2021, 9, 10)).setFin(LocalDate.of(2021, 9, 10)).setDescuento(15).setFechaRegistro(LocalDate.of(2021, 9, 10)).invoke();
        ...
        assertThrows(RegistroInconsistenteException.class, () -> {
            Set<String> profesores = new HashSet<>();
            profesores.add("profe1");
            ctrlA.crearClase().setNombreActividad("test").setNombre("test2").setInicio(LocalDateTime.of(2012, 10, 10, 0, 0)).setNicknameProfesores(profesores).setCantMin(2).setCantMax(10).setAcceso(new URL("https://test")).setFechaRegistro(LocalDate.of(2011, 10, 10)).invoke();
            man.setClases(cla);
            ctrlC.crearCuponera().setNombre("cuponera12").setDescripcion("Todo lindo").setInicio(LocalDate.of(2012, 10, 10)).setFin(LocalDate.of(2012, 10, 10)).setDescuento(15).setFechaRegistro(LocalDate.of(2012, 10, 10)).invoke();
            man.setCuponeras(cupo);
