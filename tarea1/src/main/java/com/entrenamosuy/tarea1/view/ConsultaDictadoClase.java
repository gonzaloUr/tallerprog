...
public class ConsultaDictadoClase extends JInternalFrame {
    ...
    public ConsultaDictadoClase(App app, String clase, FacadeContainer facades) {
        setMaximizable(true);
        setResizable(true);
        setClosable(true);
        ...
        DataClase dataClase = facades.getFacadeClase().getDataClase(clase);
            ...
            public void mouseClicked(MouseEvent mouseEvent) {
                ...
                if (mouseEvent.getClickCount() == 2) {
                    ...
                    if (index >= 0) {
                        ...
                        ConsultaProfesor dictadoClase = new ConsultaProfesor(app, profesor, facades);
